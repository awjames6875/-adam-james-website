      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg mb-12 max-w-3xl mx-auto text-primary-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="text-primary-600 font-semibold">Starting at $85/night</div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="text-primary-600 font-semibold">Starting at $120/session</div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <div className="text-primary-600 font-semibold">Starting at $200/hour</div>
            </div>
          </div>
        </div>
      </section>
