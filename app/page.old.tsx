        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-12">
              I believe everyone deserves a second chance—including myself. From starting over with nothing to building three thriving companies, my journey proves that your past doesn&apos;t define your future.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            >
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                The youngest of ten children from Toledo, Ohio, I learned early that success comes from serving others. After Key Bank and Merrill Lynch, I launched my first real estate company in 2001. The 2008 crash cost me everything—but I rebuilt. In 2013, I moved to Tulsa to start fresh.
              </p>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Today, I run three companies: <strong>Integrity Corporate Housing</strong> (13+ properties across 4 cities), <strong>Safe Harbor Behavioral Health</strong> (150+ children served), and <strong>GrowthGenix.ai</strong>. At least 15 companies have launched from my mentorship in the rental arbitrage space.
              </p>
              <p className="text-sm text-gray-500 mb-4 italic">
                Every entrepreneur faces setbacks. Mine made me stronger.
              </p>
              <Link href="/about">
                <motion.div
          ...
          >
            ...
            <p className="text-gray-600 mb-6 text-center">
              How I built a 7-figure real estate business from scratch through corporate housing and short-term rentals
            </p>
